...
export default function Home() {
  ...
  return (
    ...
    <div className='flex flex-wrap'>
      ...
      // <div key={product.id} className='w-80 m-2'>
      ...
      //           <img className="rounded-t-lg w-28 ml-9 h-40 " src={product.image} alt=""/>
      //         </div>
      //         <div className="p-6 text-surface dark:text-white ">
      //           <h5 className="mb-2 text-xl font-medium leading-tight h-16">{product.title}</h5>
      //           <p className="mb-4 text-base "> {product.price} $</p>
      //           <Link to={`/det/${product.id}`}
      //           type="button" className="btn inline-block rounded bg-primary px-6 pb-2 pt-3.5 text-xs font-medium uppercase leading-normal text-white shadow-primary-3 transition duration-150 ease-in-out hover:bg-primary-accent-300 hover:shadow-primary-2 focus:bg-primary-accent-300 focus:shadow-primary-2 focus:outline-none focus:ring-0 active:bg-primary-600 active:shadow-primary-2 dark:shadow-black/30 dark:hover:shadow-dark-strong dark:focus:shadow-dark-strong dark:active:shadow-dark-strong"  data-twe-ripple-init="" data-twe-ripple-color="light">
      //             Button </Link>
      //         </div>
      //       </div>
      //     </div>
